...
from app.views.controllers import generate_data_for_tiles, generate_description_for_top_item,generate_data_for_unique_items,generate_percentageof_all_infection_treatments
