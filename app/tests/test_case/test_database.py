...
class DatabaseTests(unittest.TestCase):
    ...
    def test_get_average_act_cost(self):
        ...
        self.assertEqual(self.db_mod.get_average_act_cost(), 76.22, 'Test average act cost returns correct value')
    ...
    def test_get_number_of_prescribed_antibiotics_in_RTV(self):
        ...
        self.assertListEqual(self.db_mod.get_n_antibiotics_per_practice_for_pct("RTV"), [(9,)],
                             'Test number of antibiotics per practice in RTV returns correct value')
    ...
    def test_get_n_data_for_drug(self):
        ...
        self.assertIn(self.db_mod.get_n_data_for_drug("Mucogel_Susp 195mg/220mg/5ml S/F")[0][0], pct_list,
                      'Test the data in drug information of pct')
        
    def test_get_n_data_for_drug_count(self):
        """Test the unexsiting data in drug information of pct"""
        self.assertEqual(self.db_mod.get_n_data_for_drug_count("Mucogel_Susp 195mg/220mg/5ml S/FF"), 0,
                          'Test the unexsiting data in drug information of pct')
    
    def test_get_practice_drug(self):
        """Test the practice-drug data"""
        practice_list = ['N85012', 'N85001', 'N85014', 'N85016', 'N85024', 'N85629', 'N85023', 'N85001']
        self.assertIn(self.db_mod.get_practice_drug("12F", "Mucogel_Susp 195mg/220mg/5ml S/F")[0][0],
                      practice_list, 'Test the practice-drug data')
    ...
    def test_get_distinct_drugcpde(self):
        ...
        self.assertEqual(len(self.db_mod.get_distinct_drugcode()), 13935, 'Test the distinct drug code data')
    
    def test_get_bnf_code(self):
        """Test whether the bnf name can be matched to the correct bnf code"""
        self.assertEqual(self.db_mod.get_bnf_code("Mucogel_Susp 195mg/220mg/5ml S/F"), "0101010G0BCABAB",
                        'Test whether the bnf name can be matched to the correct bnf code')
